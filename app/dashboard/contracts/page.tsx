...
import { FileText, Calendar, Building2, Search, Filter, Download, Eye, Edit, Trash2, DollarSign, Clock, AlertCircle, TrendingUp, BarChart3, Grid3x3, List, ArrowLeft, Sparkles, Upload, PieChart } from "lucide-react"
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold tracking-tight">Contract Repository</h1>
                <p className="mt-2 text-blue-100">View, manage, and analyze all your contracts in one place</p>
              </div>
            </div>
